    ...
    <div className="max-w-7xl mx-auto px-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 pb-32">
        ...
        <div className="lg:col-span-5 space-y-16">
            ...
            <div className="art-card bg-black text-white dark:bg-white dark:text-black p-10 rounded-[2.5rem] shadow-xl">
                <p className="text-[10px] font-black uppercase mb-6 opacity-40">Urgent_Contact</p>
                <p className="text-xl font-bold leading-tight uppercase italic mb-8">
                   "Response times vary between 2-24 hours depending on the current development cycle."
                </p>
                <div className="flex gap-4">
                   {profile?.linkedin && (
                     <a href={profile.linkedin} target="_blank" className="w-12 h-12 rounded-2xl bg-white/10 dark:bg-black/5 flex items-center justify-center hover:scale-110 transition-transform">
                   ...
                   {profile?.github && (
                     <a href={profile.github} target="_blank" className="w-12 h-12 rounded-2xl bg-white/10 dark:bg-black/5 flex items-center justify-center hover:scale-110 transition-transform">
